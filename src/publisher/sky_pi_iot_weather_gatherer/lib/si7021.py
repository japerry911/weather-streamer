...
"""Class for Simplified Si7021 Interaction
        Located here:
...
class SI7021(object):
    def __init__(self, i2c=None):
        ...
        self.crctab1 = (
            b"\x00\x31\x62\x53\xc4\xf5\xa6\x97" b"\xb9\x88\xdb\xea\x7d\x4c\x1f\x2e"
        )
        self.crctab2 = (
            b"\x00\x43\x86\xc5\x3d\x7e\xbb\xf8" b"\x7a\x39\xfc\xbf\x47\x04\xc1\x82"
        )
    ...
    def set_resolution(self, index):
        ...
        self._write_command(
            CMD_WRITE_RH_T_USER_REGISTER_1, (index & 2) << 6 | (index & 1)
        )
